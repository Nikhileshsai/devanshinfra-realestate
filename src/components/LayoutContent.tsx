...
export default function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-gray-900">
      <header className="bg-white dark:bg-gray-900 shadow-md py-4 px-4 flex justify-between items-center shrink-0 z-10 md:px-8"> {/* Adjusted px for mobile */}
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-900 z-50 flex flex-col md:hidden transform transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}
      >
        <button
